...
TIME_PENALITY = 0  ### -.01
RAND_PENALITY = 0    ## this will only be in the safe mode training once ghosts are in disable it
PELLET_LOST_PENALITY = -200
HIT_WALL_PENALITY = -300

PELLET_REWARD_UPDATE = 0
PELLET_REWARD = 200
POWERPELLET_REWARD = 500
FRUIT_REWARD = 1000
FINISH_LEVEL_REWARD = 50000
...
FRUIT_MAZE = 4
PACMAN_MAZE = 5
GCR_MAZE = 6  #CHASING GHOST MOVING RIGHT
GCL_MAZE = 7
GCU_MAZE = 8
GCD_MAZE = 9
GSR_MAZE = 10  #SCARED GHOST MOVING RIGHT
GSL_MAZE = 11
GSU_MAZE = 12
GSD_MAZE = 13
